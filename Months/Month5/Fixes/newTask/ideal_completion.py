...
def create_energy_charge_plot(x2, z1, z2, z3, z4, z5, z6, z7, z_ticks):
    ...
    plt.plot(x2, z1, marker='s', markersize=5, linestyle='-', label=r"(40$\circ$C)")
    plt.plot(x2, z2, marker='o', markersize=5, linestyle='-', label=r"(60$\circ$C)")
    plt.plot(x2, z3, marker='<', markersize=5, linestyle='-', label=r"(120$\circ$C)")
    plt.plot(x2, z4, marker='>', markersize=5, linestyle='-', label=r"(140$\circ$C)")
    plt.plot(x2, z5, marker='v', markersize=5, linestyle='-', label=r"(100$\circ$C)")
    plt.plot(x2, z6, marker='^', markersize=5, linestyle='-', label=r"(80$\circ$C)")
    plt.plot(x2, z7, marker='D', markersize=5, linestyle='-', label=r"(160$\circ$C)")
