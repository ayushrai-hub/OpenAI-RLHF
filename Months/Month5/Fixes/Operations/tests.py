...
class TestLogicTreeConstructor(unittest.TestCase):
    ...
    def test_add_thought(self):
        ...
        self.assertIsNone(self.tree.get_last_error())
        ...
        # Test unsuccessful addition
        self.assertFalse(self.tree.add_thought("Non-existent Thought", "Orphan Thought"))
        self.assertIsNotNone(self.tree.get_last_error())
        self.assertIn("Could not add 'Orphan Thought' to logic tree", self.tree.get_last_error())
