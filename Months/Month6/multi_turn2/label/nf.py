...
z1 = [0.4, 0.5, 0.7, 1, 1.2, 1.4, 1.5, 2, 2.2, 2.4]
z2 = [0.4, 0.7, 1, 1.3, 1.5, 1.7, 1.8, 2.3, 2.7, 3]
z3 = [0.7, 1, 1.2, 1.5, 1.7, 1.9, 2.2, 2.7, 3, 3.3]
z4 = [0.7, 1.1, 1.3, 1.6, 1.9, 2.2, 2.5, 3, 3.5, 3.9]
z5 = [0.9, 1.2, 1.4, 1.7, 2.2, 2.5, 3, 3.5, 4, 4.5]
z6 = [0.9, 1.3, 1.6, 2, 2.6, 3.2, 3.8, 4.5, 5, 5.8]
z7 = [0.9, 1.4, 1.9, 2.5, 3.2, 4, 4.8, 5.5, 6.2, 6.9]
z_ticks = [1, 2, 3, 4, 5, 6, 7, 8]
