...
def test_compile_verdicts() -> Tuple[List[pd.DataFrame], List[List[Dict]]]:
    ...
    expected_result7 = [] # Because the dataframe is invalid and contains duplicate user_signum
    ...
    expected_result8 = [] # Because the dataframe is invalid and contains duplicate user_signum
