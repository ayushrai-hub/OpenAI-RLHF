...
if __name__=="__main__":
    ...
    while True:
        ...
        if option == 1:
            ...
            pair = binary_tree.find_pair_with_sum(k)
            if pair:
            ...
            print("Top Side View of Tree:", binary_tree.top_view())
        elif option == 19:
            print("Bottom Side View of Tree:", binary_tree.bottom_view())
        elif option == 20:
            break
        else:
