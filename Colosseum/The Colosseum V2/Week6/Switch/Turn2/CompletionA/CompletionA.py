...
class MyApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        load_button = ttk.Button(self.shared_frame, text="Import Transaction Records", command=self.load_records, style="TButton")
        load_button.pack(side=tk.LEFT, expand=True, fill=tk.X, padx=5)

        self.show_graph_button = ttk.Button(self.shared_frame, text="Show Graph", command=self.show_graph, style="TButton")
        ...
        # Graph interface widgets (initially empty, add your graph widgets here)
    ...
    def show_graph(self):
        ...
        # Update buttons
        self.show_graph_button.config(text="Show Data", command=self.show_data)
    ...
    def show_data(self):
        ...
        # Update buttons
        self.show_graph_button.config(text="Show Graph", command=self.show_graph)
